...
# Title and subtitle
st.markdown("<h1 style='text-align: center;'>Enhancing Quality Assurance: Fabric Defect Detection using Computer Vision</h1>", unsafe_allow_html=True)
# st.markdown("<h2 style='text-align: center;color: darkblue'>Utilizing Computer Vision Techniques for Accurate and Efficient Fabric Defect Identification and Localization!<br></h2>", unsafe_allow_html=True)
